...
<div class="panel-shell">
  <div class="panel">
    ...
    <div class="panel-credit">
      ...
      by
      <button class="credit-link logo-link" onclick={() => openUrl("https://unravel.tech")} aria-label="unravel.tech">
...
<style>
  ...
  .panel-credit .logo-link {
    display: inline-flex;
    align-items: center;
    line-height: 0;
    transition: opacity 0.15s var(--ease);
  }
  .panel-credit .logo-link:hover {
    opacity: 0.7;
    text-decoration: none;
  }
  .panel-credit .unravel-logo {
    height: 12px;
    width: auto;
    display: block;
  }
